...
import { LogOut, GraduationCap, Loader2, User as UserIcon, X, Sparkles, ShieldCheck, Zap } from 'lucide-react';
    ...
    >
      <div className="relative">
        ...
        >
          ...
          >
            <h1 className="text-2xl font-black tracking-tighter text-neutral-900">STUDY TRACKER</h1>
...
export default function App() {
      ...
      if (firebaseUser) {
        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            const isAdminEmail = firebaseUser.email === 'carlesirodriguez7@gmail.com';
      ...
      <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-6 font-sans">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <h1 className="text-3xl font-black tracking-tight text-neutral-900 mb-3">Welcome back</h1>
          ...
          <div className="grid grid-cols-3 gap-4 mb-10">
            {[
              ...
              >
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-400">{f.label}</span>
              </motion.div>
            ))}
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-center text-[11px] text-neutral-400 font-medium px-6 leading-relaxed">
              By continuing, you agree to our <span className="underline cursor-pointer hover:text-neutral-600">Terms</span> and <span className="underline cursor-pointer hover:text-neutral-600">Privacy Policy</span>.
            </p>
          </div>
        </motion.div>
      </div>
  ...
  const isAdmin = profile.role === 'admin' || profile.email === 'carlesirodriguez7@gmail.com';
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4 md:gap-8">
            <div className="flex items-center gap-3">
              ...
              <span className="font-black text-xl tracking-tighter uppercase hidden sm:inline">Study.</span>
            </div>
              ...
              <div className="flex items-center gap-1 bg-neutral-100 p-1 rounded-2xl">
                <button 
                  ...
                  className={`px-3 md:px-6 py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all ${
                    view === 'dashboard' ? 'bg-white text-neutral-900 shadow-sm' : 'text-neutral-400 hover:text-neutral-600'
                  }`}
                >
                  Dashboard
                </button>
                <button 
                  ...
                  className={`px-3 md:px-6 py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all ${
                    view === 'admin' ? 'bg-white text-neutral-900 shadow-sm' : 'text-neutral-400 hover:text-neutral-600'
                  }`}
                >
                  Admin
                </button>
